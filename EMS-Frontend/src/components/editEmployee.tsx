...
const EditEmployee = () => {
  ...
  const { jobTitle, setJobTitle, formatDate } = useEmployee();
        ...
        .then(result => {
          if (result.data.Status) {
            ...
            setEmployeeDetails({
              ...
              join_date: formatDate(employee.join_date), // Convert to YYYY-MM-DD format
              visa_expiry_date: formatDate(employee.visa_expiry_date), // Convert to YYYY-MM-DD format
              mohre_id: employee.mohre_id,
              work_permit_expiry_date: formatDate(employee.work_permit_expiry_date) // Convert to YYYY-MM-DD format
            });
          } else {
            alert(result.data.Error);
          }
